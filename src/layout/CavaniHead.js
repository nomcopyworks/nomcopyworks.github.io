...
const CavaniHead = () => {
  return (
    <Head>
      ...
      <meta name="description" content="Mathew Labar, Visionary footwear designer and creator! Contact for custom inquiries." />
      <meta name="author" content="Naram Alhasani" />
      <meta
        name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1"
      />
      <title>Matt LaBar - Footwear Designer</title>
      {/* STYLES */}
      <link
      ...
      <link
        ...
        rel="stylesheet"
      />
      <link rel="shortcut icon" href="assets/img/Website/MLlogo.jpg" type="image/png" />
